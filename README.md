...
## 10. Интегриране на ИИ (Gemini)

В рамките на дисциплината „Интегриране на ИИ в апликации“ (2025–2026 г.) към приложението е добавена AI функционалност чрез Firebase AI Logic и Google Gemini.

### Какво прави:
Потребителят може автоматично да генерира подзадачи от въведено заглавие на задача.

### Как работи:
1. Въвежда се заглавие на задача  
2. Натиска се бутон **"Generate with AI"**  
3. Приложението изпраща заявка към Gemini  
4. AI генерира списък от подзадачи  
5. Резултатът се добавя в Description  
